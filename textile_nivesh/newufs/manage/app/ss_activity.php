   ...
   <div class="page-content">
      <div class="page-bar">
         <div class="page-title-breadcrumb"> 
            <div class=" pull-left">
               <div class="page-title">Activity List</div>
            </div>
                  ...
                  <div class="table-scrollable">
                     <table class="table table-hover table-checkable order-column full-width" id="example4">
                        ...
                        <tbody>
                           <?php
                            $role = new Property();
                            $result = $role->get_working_activity();
                            $i=0;
                           ...
                           <tr class="odd gradeX">
                              ...
                              <td class=""><?php echo $row['u_name'];?></td>
                              <td class=""><?php echo $row['a_message'];?></td>
                              <td class=""><?php echo $row['a_type'];?></td>
