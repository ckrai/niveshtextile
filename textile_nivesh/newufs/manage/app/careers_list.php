                  ...
                  <div class="table-scrollable">
                     <table class="table table-hover table-checkable order-column full-width" id="example4">
                        ...
                        <tbody>
                          <?php
                              $careers = new Careers();
                              $result   = $careers->get_careers();
                              $i=0;
                              foreach($result as $row)
                               {
                                 $i++;
                                 $active = $row['career_status'];
                                 $id     = $row['career_id'];
                            ?>
                           <tr class="odd gradeX">
                             <td><?php echo $i; ?></td>
                                <td><?php echo substr($row['career_title'], 0, 20). '...';?></td>
                                <td><?php echo substr($row['career_description'], 0, 80). '...'; ?></td>
                                <td>
                              ...
                              <td class="">
                                 <a href="career_update?career=<?php echo $row['career_id']; ?>"   class="btn btn-tbl-edit btn-xs">
   ...
   // Enable/Disable Tender.
                $('.active').click(function(){
                    ...
                    $.ajax({
                        ...
                        type: 'post',
                        data: {careers_id: careers_id, active: active, request: 1},
...
<script type="text/javascript" language="javascript" >
   $(document).ready(function(){
      ...
      $('.delete').click(function(){
          ...
          var careers_id   = this.id;
          // AJAX request
          $.ajax({
              url: 'action/careers_status_update',
              type: 'post',
              data: {careers_id: careers_id, request: 2},
