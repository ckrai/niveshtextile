...
<head>
  ...
  <title>VAA Financial | Payment List</title>
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools">
                  <a href="payment_recived.php" class="nav-link"><button type="button" class="btn btn-block bg-gradient-primary">Add New Payment</button></a>
            </div>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                      <?php
                        $payment = new Payment();
                        $result = $payment->get_payment_list();
                        $i=0;
                  ...
                  <tr>
                    ...
                    <td><?php echo $row['payrec_mode'];?></td>
                    <td><?php echo $row['payrec_status'];?></td>
                    <td>
