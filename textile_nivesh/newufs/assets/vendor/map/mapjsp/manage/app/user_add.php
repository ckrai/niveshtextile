...
<head>
  ...
  <title>VAA Financial| Add User </title>
      ...
      <!-- <div class="container-fluid"> -->
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">User Reg Form</h3>
              ...
              <div class="col-md-4">
                <div class="form-group">
                 ...
                 <select class="form-control select2" name="type" id="type" style="width: 100%;">
                  ...
                  <?php
                      $user = new User();
                      $result = $user->get_user_role();
                       while($row = $result->fetch(PDO::FETCH_ASSOC))
                        {
                        ?>
                        
                        <option value="<?php echo $row["role_id"].'_'.$row["role_name"];?>"><?php echo $row["role_name"];?></option>
       ...
       $(document).on('submit', '#reg_form', function(e){
           e.preventDefault();
            $("#spinner-div").show(); 
              ...
              var type     = $('#type').val();
           if(name != '' && mobile != ''  && email != '' && district != '' && type != '' )
           {
               $.ajax({
                   url:"action/add-user",
                   method:'POST',
