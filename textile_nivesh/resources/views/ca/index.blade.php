    ...
    <div class="row justify-content-center">
        ...
        <div class="card">
            <div class="card-body">
                ...
                @endif
                {{ __('You are logged in CA User!') }}
            </div>
        </div>
        <br/>

        <!--  <div class="topnav">
        <a class="btn btn-success btn-submit" href="{{ route ('ca.list')}}" style="float:right;"> Refresh</a>
        </div> -->
        <br>
    ...
    <table id="example1" class="table table-bordered table-hover">
        ...
        <tbody>
           @forelse ($applicants as $applicant)
            ...
            <a href="{{ route('ca.edit', $applicant->id) }}" class="btn btn-sm btn-outline-danger py-0">Edit</a>
            <a href="{{ route('ca.view', $applicant->id) }}" class="btn btn-sm btn-outline-success py-0">Review</a>
            </td>
           </tr>
          @empty
