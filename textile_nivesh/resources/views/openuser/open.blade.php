...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="card">
            <div class="card-body">
                ...
                @endif
                {{ __('You are logged in Open User!') }} 
                <a class="btn btn-success" href="{{route('openuser.index')}}" style="float:right;">Refresh</a>
            </div>
        </div>
        <br/>
        ...
        <form action="{{ route('openuser.simple_search') }}" method="GET">
 ...
 -->
        ...
        <legend style="color: green; font-weight: bold;">All Nivesh Form List</legend>
        ...
        <table id="example1" class="table table-bordered table-hover">
           ...
           <tbody>
               @forelse ($applicants as $applicant)
                ...
                <a href="#" class="btn btn-sm btn-outline-success py-0">View</a>
                </td>
               </tr>
                @empty
