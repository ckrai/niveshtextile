...
<div class="container">
  ...
  @endif
  <legend style="color: #38c172; font-weight: bold; padding-top: 10px;">Nivesh Update Form
  <a href="{{ route('applicant.list') }}" class="btn btn-success"  style="float: right; display: block; padding: 1px 5px 1px 5px; text-decoration: none; border-radius: 5px; font-size: 16px; margin-right: 5px;"> Back</a>
  </legend>
    ...
    <table id="example1" class="table table-bordered table-hover">
        ...
        <th class="text-center">Applicant Name, Address & Contact<br><h6>Certificate of Incorporation, Registered partnership deep deed, Trust/Society registration deed.</h6></th>
