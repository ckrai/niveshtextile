...
<div class="container">
    ...
    <div class="col-md-12">
      <div class="form-group" style="margin-top: 24px;"><a href="{{ route('expert.list') }}" class="btn btn-success">Back</a></div>
      @if(session()->has('message'))
        <p class="btn btn-success btn-block btn-sm custom_message text-left">{{ session()->get('message') }}</p>
      @endif
    <legend style="color: green; font-weight: bold;">Expert Update Form </legend>
    <table id="example1" class="table table-bordered table-hover">
        ...
        <form action="javascript:void(0)" method="post" class="update_expert" enctype="multipart/form-data">
          {{ csrf_field() }}
          <td><input class="form-control fw-normal mb-1" type="text" name="remark_expert" id="remark_expert">
              <input type="hidden" name="remark_expert_field" value="expert_remark_n_applicant">
        ...
        {{ csrf_field() }}
        <td><input class="form-control fw-normal mb-1" type="text" name="remark_expert" id="remark_expert">
            <input type="hidden" name="remark_expert_field" value="expert_remark_constitution">
            <input type="hidden" name="applicant_id" id="applicant_id" value="{{$applicant->id}}">
        </td>
        <td><button class="btn btn-primary" name="upload1" id="upload1" type="submit">Update</button></td>
        </form>
        ...
        {{ csrf_field() }}
        <td><input class="form-control fw-normal mb-1" type="text" name="remark_expert" id="remark_expert">
            <input type="hidden" name="remark_expert_field" value="expert_remark_textile_industry">
            <input type="hidden" name="applicant_id" id="applicant_id" value="{{$applicant->id}}">
        </td>
        <td><button class="btn btn-primary" name="upload1" id="upload1" type="submit">Update</button></td>
        </form>
        ...
        {{ csrf_field() }}
        <td><input class="form-control fw-normal mb-1" type="text" name="remark_expert" id="remark_expert">
            <input type="hidden" name="remark_expert_field" value="expert_remark_nature_of_textile">
            <input type="hidden" name="applicant_id" id="applicant_id" value="{{$applicant->id}}">
        </td>
        <td><button class="btn btn-primary" name="upload1" id="upload1" type="submit">Update</button></td>
        </form>
        ...
        {{ csrf_field() }}
        <td><input class="form-control fw-normal mb-1" type="text" name="remark_expert" id="remark_expert">
            <input type="hidden" name="remark_expert_field" value="expert_remark_proposed_capital">
            <input type="hidden" name="applicant_id" id="applicant_id" value="{{$applicant->id}}">
        </td>
        <td><button class="btn btn-primary" name="upload1" id="upload1" type="submit">Update</button></td>
        </form>
        ...
        {{ csrf_field() }}
        <td><input class="form-control fw-normal mb-1" type="text" name="remark_expert" id="remark_expert">
            <input type="hidden" name="remark_expert_field" value="expert_remark_p_side_address">
            <input type="hidden" name="applicant_id" id="applicant_id" value="{{$applicant->id}}">
        </td>
        <td><button class="btn btn-primary" name="upload1" id="upload1" type="submit">Update</button></td>
        </form>
        ...
        {{ csrf_field() }}
        <td><input class="form-control fw-normal mb-1" type="text" name="remark_expert" id="remark_expert">
            <input type="hidden" name="remark_expert_field" value="expert_remark_gstin">
            <input type="hidden" name="applicant_id" id="applicant_id" value="{{$applicant->id}}">
        </td>
        <td><button class="btn btn-primary" name="upload1" id="upload1" type="submit">Update</button></td>
        </form>
        ...
        {{ csrf_field() }}
        <td><input class="form-control fw-normal mb-1" type="text" name="remark_expert" id="remark_expert">
        <input type="hidden" name="remark_expert_field" value="expert_remark_estab_copy_undertaking">
        <input type="hidden" name="applicant_id" id="applicant_id" value="{{$applicant->id}}">
        </td>
        <td><button class="btn btn-primary" name="upload1" id="upload1" type="submit">Update</button></td>
        </form>
        ...
        {{ csrf_field() }}
        <td><input class="form-control fw-normal mb-1" type="text" name="remark_expert" id="remark_expert">
        <input type="hidden" name="remark_expert_field" value="expert_remark_date_from_capital_invest">
        <input type="hidden" name="applicant_id" id="applicant_id" value="{{$applicant->id}}">
        </td>
        <td><button class="btn btn-primary" name="upload1" id="upload1" type="submit">Update</button></td>
        </form>
        ...
        {{ csrf_field() }}
        <td><input class="form-control fw-normal mb-1" type="text" name="remark_expert" id="remark_expert">
        <input type="hidden" name="remark_expert_field" value="expert_remark_whether_capital_invest">
        <input type="hidden" name="applicant_id" id="applicant_id" value="{{$applicant->id}}">
        </td>
        <td><button class="btn btn-primary" name="upload1" id="upload1" type="submit">Update</button></td>
        </form>
        ...
        {{ csrf_field() }}
        <td><input class="form-control fw-normal mb-1" type="text" name="remark_expert" id="remark_expert">
            <input type="hidden" name="remark_expert_field" value="expert_remark_total_amount">
            <input type="hidden" name="applicant_id" id="applicant_id" value="{{$applicant->id}}">
        </td>
        <td><button class="btn btn-primary" name="upload1" id="upload1" type="submit">Update</button></td>
        </form>
        ...
        {{ csrf_field() }}
        <td><input class="form-control fw-normal mb-1" type="text" name="remark_expert" id="remark_expert">
            <input type="hidden" name="remark_expert_field" value="expert_remark_details_applied_financial">
            <input type="hidden" name="applicant_id" id="applicant_id" value="{{$applicant->id}}">
        </td>
        <td><button class="btn btn-primary" name="upload1" id="upload1" type="submit">Update</button></td>
        </form>
        ...
        {{ csrf_field() }}
        <td><input class="form-control fw-normal mb-1" type="text" name="remark_expert" id="remark_expert">
            <input type="hidden" name="remark_expert_field" value="expert_remark_exemption_stamp_duty">
            <input type="hidden" name="applicant_id" id="applicant_id" value="{{$applicant->id}}">
        </td>
        <td><button class="btn btn-primary" name="upload1" id="upload1" type="submit">Update</button></td>
        </form>
        ...
        {{ csrf_field() }}
        <td><input class="form-control fw-normal mb-1" type="text" name="remark_expert" id="remark_expert">
            <input type="hidden" name="remark_expert_field" value="expert_remark_exemption_state_tax">
            <input type="hidden" name="applicant_id" id="applicant_id" value="{{$applicant->id}}">
        </td>
        <td><button class="btn btn-primary" name="upload1" id="upload1" type="submit">Update</button></td>
        </form>
        ...
        {{ csrf_field() }}
        <td><input class="form-control fw-normal mb-1" type="text" name="remark_expert" id="remark_expert">
        <input type="hidden" name="remark_expert_field" value="expert_remark_additional_reimbursement">
        <input type="hidden" name="applicant_id" id="applicant_id" value="{{$applicant->id}}">
        </td>
        <td><button class="btn btn-primary" name="upload1" id="upload1" type="submit">Update</button></td>
        </form>
        ...
        {{ csrf_field() }}
        <td><input class="form-control fw-normal mb-1" type="text" name="remark_expert" id="remark_expert">
            <input type="hidden" name="remark_expert_field" value="expert_remark_capital_subsidy">
            <input type="hidden" name="applicant_id" id="applicant_id" value="{{$applicant->id}}">
        </td>
        <td><button class="btn btn-primary" name="upload1" id="upload1" type="submit">Update</button></td>
        </form>
        ...
        {{ csrf_field() }}
        <td><input class="form-control fw-normal mb-1" type="text" name="remark_expert" id="remark_expert">
            <input type="hidden" name="remark_expert_field" value="expert_remark_intrest_subsidy">
            <input type="hidden" name="applicant_id" id="applicant_id" value="{{$applicant->id}}">
        </td>
        <td><button class="btn btn-primary" name="upload1" id="upload1" type="submit">Update</button></td>
        </form>
        ...
        {{ csrf_field() }}
        <td><input class="form-control fw-normal mb-1" type="text" name="remark_expert" id="remark_expert">
            <input type="hidden" name="remark_expert_field" value="expert_remark_additional_intrest_subsidy">
            <input type="hidden" name="applicant_id" id="applicant_id" value="{{$applicant->id}}">
        </td>
        <td><button class="btn btn-primary" name="upload1" id="upload1" type="submit">Update</button></td>
        </form>
        ...
        {{ csrf_field() }}
        <td><input class="form-control fw-normal mb-1" type="text" name="remark_expert" id="remark_expert">
            <input type="hidden" name="remark_expert_field" value="expert_remark_margin_money_grant">
            <input type="hidden" name="applicant_id" id="applicant_id" value="{{$applicant->id}}">
        </td>
        <td><button class="btn btn-primary" name="upload1" id="upload1" type="submit">Update</button></td>
        </form>
        ...
        {{ csrf_field() }}
        <td><input class="form-control fw-normal mb-1" type="text" name="remark_expert" id="remark_expert">
        <input type="hidden" name="remark_expert_field" value="expert_remark_additional_5_per_margin">
        <input type="hidden" name="applicant_id" id="applicant_id" value="{{$applicant->id}}">
        </td>
        <td><button class="btn btn-primary" name="upload1" id="upload1" type="submit">Update</button></td>
        </form>
        ...
        {{ csrf_field() }}
        <td><input class="form-control fw-normal mb-1" type="text" name="remark_expert" id="remark_expert">
            <input type="hidden" name="remark_expert_field" value="expert_remark_infra_intrest_subsidy">
            <input type="hidden" name="applicant_id" id="applicant_id" value="{{$applicant->id}}">
        </td>
        <td><button class="btn btn-primary" name="upload1" id="upload1" type="submit">Update</button></td>
        </form>
        ...
        {{ csrf_field() }}
        <td><input class="form-control fw-normal mb-1" type="text" name="remark_expert" id="remark_expert">
            <input type="hidden" name="remark_expert_field" value="expert_remark_additional_per_infra">
            <input type="hidden" name="applicant_id" id="applicant_id" value="{{$applicant->id}}">
        </td>
        <td><button class="btn btn-primary" name="upload1" id="upload1" type="submit">Update</button></td>
        </form>
        ...
        {{ csrf_field() }}
        <td><input class="form-control fw-normal mb-1" type="text" name="remark_expert" id="remark_expert">
        <input type="hidden" name="remark_expert_field" value="expert_remark_additional_25_per_working">
        <input type="hidden" name="applicant_id" id="applicant_id" value="{{$applicant->id}}">
        </td>
        <td><button class="btn btn-primary" name="upload1" id="upload1" type="submit">Update</button></td>
        </form>
        ...
        {{ csrf_field() }}
        <td><input class="form-control fw-normal mb-1" type="text" name="remark_expert" id="remark_expert">
            <input type="hidden" name="remark_expert_field" value="expert_remark_epf_reimbursement">
            <input type="hidden" name="applicant_id" id="applicant_id" value="{{$applicant->id}}">
        </td>
        <td><button class="btn btn-primary" name="upload1" id="upload1" type="submit">Update</button></td>
        </form>
        ...
        {{ csrf_field() }}
        <td><input class="form-control fw-normal mb-1" type="text" name="remark_expert" id="remark_expert">
        <input type="hidden" name="remark_expert_field" value="expert_remark_additional_epf_reimbursement">
        <input type="hidden" name="applicant_id" id="applicant_id" value="{{$applicant->id}}">
        </td>
        <td><button class="btn btn-primary" name="upload1" id="upload1" type="submit">Update</button></td>
        </form>
        ...
        {{ csrf_field() }}
        <td><input class="form-control fw-normal mb-1" type="text" name="remark_expert" id="remark_expert">
        <input type="hidden" name="remark_expert_field" value="expert_remark_reimbursement_of_freight">
        <input type="hidden" name="applicant_id" id="applicant_id" value="{{$applicant->id}}">
        </td>
        <td><button class="btn btn-primary" name="upload1" id="upload1" type="submit">Update</button></td>
        </form>
        ...
        {{ csrf_field() }}
        <td><input class="form-control fw-normal mb-1" type="text" name="remark_expert" id="remark_expert">
            <input type="hidden" name="remark_expert_field" value="expert_remark_gap_filling_grant">
            <input type="hidden" name="applicant_id" id="applicant_id" value="{{$applicant->id}}">
        </td>
        <td><button class="btn btn-primary" name="upload1" id="upload1" type="submit">Update</button></td>
        </form>
        ...
        {{ csrf_field() }}
        <td><input class="form-control fw-normal mb-1" type="text" name="remark_expert" id="remark_expert">
        <input type="hidden" name="remark_expert_field" value="expert_remark_exemption_from_electricity">
        <input type="hidden" name="applicant_id" id="applicant_id" value="{{$applicant->id}}">
        </td>
        <td><button class="btn btn-primary" name="upload1" id="upload1" type="submit">Update</button></td>
        </form>
        ...
        {{ csrf_field() }}
        <td><input class="form-control fw-normal mb-1" type="text" name="remark_expert" id="remark_expert">
            <input type="hidden" name="remark_expert_field" value="expert_remark_exemption_from_mandi">
            <input type="hidden" name="applicant_id" id="applicant_id" value="{{$applicant->id}}">
        </td>
        <td><button class="btn btn-primary" name="upload1" id="upload1" type="submit">Update</button></td>
        </form>
        ...
        {{ csrf_field() }}
        <td><input class="form-control fw-normal mb-1" type="text" name="remark_expert" id="remark_expert">
            <input type="hidden" name="remark_expert_field" value="expert_remark_acknowledgment_of_uam">
            <input type="hidden" name="applicant_id" id="applicant_id" value="{{$applicant->id}}">
        </td>
        <td><button class="btn btn-primary" name="upload1" id="upload1" type="submit">Update</button></td>
        </form>
        ...
        {{ csrf_field() }}
        <td><input class="form-control fw-normal mb-1" type="text" name="remark_expert" id="remark_expert">
            <input type="hidden" name="remark_expert_field" value="expert_remark_audited_accounts_unit">
            <input type="hidden" name="applicant_id" id="applicant_id" value="{{$applicant->id}}">
        </td>
        <td><button class="btn btn-primary" name="upload1" id="upload1" type="submit">Update</button></td>
        </form>
        ...
        {{ csrf_field() }}
        <td><input class="form-control fw-normal mb-1" type="text" name="remark_expert" id="remark_expert">
            <input type="hidden" name="remark_expert_field" value="expert_remark_dpr">
            <input type="hidden" name="applicant_id" id="applicant_id" value="{{$applicant->id}}">
        </td>
        <td><button class="btn btn-primary" name="upload1" id="upload1" type="submit">Update</button></td>
        </form>
        ...
        {{ csrf_field() }}
        <td><input class="form-control fw-normal mb-1" type="text" name="remark_expert" id="remark_expert">
            <input type="hidden" name="remark_expert_field" value="expert_remark_cac_for_existing_gross">
            <input type="hidden" name="applicant_id" id="applicant_id" value="{{$applicant->id}}">
        </td>
        <td><button class="btn btn-primary" name="upload1" id="upload1" type="submit">Update</button></td>
        </form>
        ...
        {{ csrf_field() }}
        <td><input class="form-control fw-normal mb-1" type="text" name="remark_expert" id="remark_expert">
            <input type="hidden" name="remark_expert_field" value="expert_remark_cac_for_fixed_gross">
            <input type="hidden" name="applicant_id" id="applicant_id" value="{{$applicant->id}}">
        </td>
        <td><button class="btn btn-primary" name="upload1" id="upload1" type="submit">Update</button></td>
        </form>
        ...
        {{ csrf_field() }}
        <td><input class="form-control fw-normal mb-1" type="text" name="remark_expert" id="remark_expert">
            <input type="hidden" name="remark_expert_field" value="expert_remark_affidavit">
            <input type="hidden" name="applicant_id" id="applicant_id" value="{{$applicant->id}}">
        </td>
        <td><button class="btn btn-primary" name="upload1" id="upload1" type="submit">Update</button></td>
        </form>
        ...
        <script type="text/javascript">
          ...
          $('.update_expert').submit(function(e) {
          //alert(23);
          e.preventDefault();
          var formData = new FormData(this);
          $.ajax({
          type:'post',
          url: "{{ url('expert/{expert}')}}",
          data: formData,
          cache:false,
          contentType: false,
          processData: false,
