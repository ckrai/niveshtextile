...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-12">
          ...
          <a href="{{ route('expert.list') }}" class="btn btn-success">Back</a>
          <a href="{{ route('expert.list') }}" class="btn btn-success" style="float: right; display: block;"> LIST</a>
          </div>
          <!-- <legend style="color: #38c172; font-weight: bold;"> Details</legend> -->
