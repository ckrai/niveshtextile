...
/*
                        <div class="form-group row">
                            ...
                            <select id="role" type="number" class="form-control @error('role') is-invalid @enderror dropdown-toggle" name="role" value="{{ old('role') }}" required autocomplete="role">
                                <option value="">Select Role</option>
                                <option value="1">Super Admin</option>
                                <option value="2">Upicon</option>
                                <option value="3">CA</option>
                                <option value="4">Expert</option>
                                <option value="5">Applicant</option>
                                <option value="6">Open Users</option>
                            </select>
